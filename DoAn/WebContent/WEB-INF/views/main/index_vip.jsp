					...
					<!-- Dropdown theo tên người dùng để update -->
							...
							<div class="container-fluid container_hello_guest">
								...
								<div class="container-fluid container-introduction">
									...
									<!-- Send request Movie -->
									<div class="container-request-movie-index-vip ">
										<img alt="" src="/DoAn/resources/images/index_vip/background_request_movie.JPG" class="background-request-index-vip">
										<p id="request_movie">Request movie</p>
										<p id="request-movie-quote">"Cannot find your favorite movie ? Request to us now !!!"</p>
										<a href="/DoAn/main/request_movie/${username}.htm"><button type="button" class="btn btn-primary btn-request-movie">Request</button></a>
									</div>
														<!-- Footer -->
