...
<html lang="en" dir="ltr">
  ...
  <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet">
    ...
    <meta charset="utf-8">
    <title>Show Information User</title>
    <link href=" 
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav ml-auto mx-auto ">
  			...
  			<!-- Hình avatar -->
  						...
  						<img alt="" src="${user.image_avatar}" id="admin_avatar_round_image">
  			<!-- Hết hình -->
  				
  							<h3 style="text-align: center;">USER'S INFORMATION</h3>
  						<div id="text-information">
  							<h5>Account's name: ${user.username}</h5>
  							<br>
  							<h5>Name of user: ${user.name_of_user}</h5>
  							<br>
  							<h5>VIP/Standard: ${user.user_type.type_name }</h5>
  							<br>
  							<a href="/DoAn/main/update_user/${user.username}.htm"><button type="button" class="btn btn-primary btn-update-show-information">Update</button></a>
  						</div>
