					...
					<!-- Dropdown theo tên người dùng để update -->
							...
							<div class="container-fluid container_hello_guest">
								...
								<div class="container-fluid container-introduction">
									...
									<!-- Show statistic -->
									<div class="container-fluid container-statistic">
										<h3 style="text-align: center;">WEBSITE'S STATISTIC</h3>
										<div class="container-number-of-user-left">
											<a href="/DoAn/main/show_list_user.htm" style="display: block;font-size: 3vw;">${count_number_of_user}</a>
											<p><a href="/DoAn/main/show_list_user.htm" style="display: block"></a>Users registered on website</p>
										</div>
										<div class="container-number-of-movie-middle">
										<a href="/DoAn/main/show_list_movie.htm" style="display: block;font-size: 3vw;">${count_number_of_movie}</a>
											<p>Movies upated on website</p>
										</div>
										<div class="container-number-of-request-right">
										<a href="/DoAn/main/show_list_request.htm" style="display: block;font-size: 3vw;">${count_number_of_request}</a>
											<p>Requests on website</p>
										</div>
									</div>
